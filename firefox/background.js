...
const BrowserAdapter = {
  // Icon API adapter - Firefox only has browserAction
  async setIcon(iconPath) {
    // Firefox uses browserAction (this is the Firefox build)
  ...
  formatResponse(data) {
    // Firefox expects wrapped response (this is the Firefox build)
